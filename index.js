...
class Developer extends Person {
    /* Constructor */
    constructor(nombre, edad, say, lenguaje) {
...
//--------- PUNTO 5 ----------//
const developer = new Developer('pedro', 35, (something) => console.log(something), (language) => console.log(language + ' is the best language'));
developer.myNameIs();
developer.saySomething('algo');
//developer.bestLanguage('Javascript'); 
